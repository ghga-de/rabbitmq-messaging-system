...
def sub():
    ...
    print("All the messages producer before this moment has been lost.")
...
def callback(chan, method, _properties, body):
    ...
    print(
        f"Received {msg} and acknowledging the message with delivery tag {method.delivery_tag}"
    )
